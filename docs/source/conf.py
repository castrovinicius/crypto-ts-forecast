...
# crypto_ts_forecast documentation build
...
from crypto_ts_forecast import __version__ as release

# -- Project information -----------------------------------------------------

project = "crypto_ts_forecast"
author = "Kedro"
...
htmlhelp_basename = "crypto_ts_forecastdoc"
...
latex_documents = [
    (
        master_doc,
        "crypto_ts_forecast.tex",
        "crypto_ts_forecast Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "crypto_ts_forecast",
        "Project crypto_ts_forecast codebase.",
        "Data-Science",
    )
]
