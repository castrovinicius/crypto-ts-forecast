...
from crypto_ts_forecast.pipelines.data_ingestion.nodes import fetch_bitcoin_klines, validate_raw_data
...
class TestDataIngestionNodes:
    ...
    def test_fetch_bitcoin_klines(self, mock_get):
        ...
        mock_response.json.side_effect = [
            [
                [1609459200000, "29000.0", "29500.0", "28500.0", "29300.0", "1000.0", 1609545599999, "29000000.0", 10000, "500.0", "14500000.0", "0"],
            ],
