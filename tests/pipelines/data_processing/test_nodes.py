...
class TestDataProcessingNodes:
    ...
    def test_add_features_with_volume(self, sample_validated_data):
        ...
        enhanced_df = add_features(prophet_df, add_volume=True, validated_data=sample_validated_data)
    ...
    def test_add_features_no_volume(self, sample_validated_data):
        ...
        enhanced_df = add_features(prophet_df, add_volume=False, validated_data=sample_validated_data)
