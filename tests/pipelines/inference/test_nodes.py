...
class TestInferenceNodes:
    ...
    def test_create_future_dataframe(self, sample_prophet_data):
        ...
        future_dates = pd.date_range(start="2021-01-01", periods=35, freq="D") # 30 historical + 5 future
    ...
    def test_generate_forecast(self):
        mock_model = Mock()
        future_df = pd.DataFrame({"ds": pd.date_range(start="2021-01-01", periods=5, freq="D")})
